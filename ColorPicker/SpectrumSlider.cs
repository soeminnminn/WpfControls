...
namespace ColorPicker
{
    ...
    internal class SpectrumSlider : SliderEx
    {
        ...
        public static readonly DependencyProperty HueProperty = DependencyProperty.Register(
            nameof(Hue), typeof(double), typeof(SpectrumSlider),
        ...
        protected override void OnValueChanged(double oldValue, double newValue)
        {
            ...
            if (!withinChanging && !BindingOperations.IsDataBound(this, HueProperty))
            {
                withinChanging = true;
                Hue = newValue;
                withinChanging = false;
            }
        }
